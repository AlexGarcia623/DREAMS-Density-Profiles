...
x = np.load('./data/Fig8_median_x.npy') * np.mean(rvir)
median = np.load('./data/Fig8_median_y.npy')
low = np.load('./data/Fig8_low_y.npy'   )
high = np.load('./data/Fig8_high_y.npy'  )
...
plt.savefig(f'./figs/Figure9.pdf',bbox_inches='tight')
